# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 09:03:36 2023
...
parser.add_argument('--filename', type=str, default='logs/out_probs_val.npy',
...
savemat("map_val.mat", mdict)

# Step 1: Visualize results
ax = sns.heatmap(edges_results_visual,
                 cmap="Blues")
plt.savefig('logs/probs_val.png', dpi=600)
# plt.show()
plt.close()
...
ax.set_ylim([7, 0])
plt.savefig('logs/edges_domain_val.png', dpi=600)
# plt.show()
plt.close()
